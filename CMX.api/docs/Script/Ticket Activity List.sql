SELECT ATA.AccountTicketActivityID, InvoiceNumber, PA.Address1 + ' ' + PA.Address2 + ' ' + PA.Address3 AS Address, PA.Zip, AT.Description AS Workplan, ATA.Description AS Activity, ATA.PlanStartDate, ATA.PlanDueDate
